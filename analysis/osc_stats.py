...
def sortSubjectFiles(waveletPath, sim):
	...
	subjectNames = os.listdir(waveletPath)
...
def plotStats():
	...
	waveletPathSim = '../data/v34_batch57/osc_events_data/'
	waveletPathNHP = '../data/NHPdata/spont/osc_events_data/'

	simSubjects = sortSubjectFiles(waveletPath=waveletPathSim, sim=1)
	nhpSubjects = sortSubjectFiles(waveletPath=waveletPathNHP, sim=0)
	...
	durDictSim, peakFDictSim, ncycleDictSim = getPropDicts(simSubjects, frequencyBands, waveletPathSim, propType='all', sim=1)
	...
	durDictNHP, peakFDictNHP, ncycleDictNHP = getPropDicts(nhpSubjects, frequencyBands, waveletPathNHP, propType='all', sim=0)
